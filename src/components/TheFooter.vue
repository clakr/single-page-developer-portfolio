...
.form__group:has(input:invalid) > :is(span, img) {
  display: block;
}
...
@media screen and (min-width: 768px) {
  footer {
    ...
    background-position: top 54.7rem left -36.8rem;
  }
...
@media screen and (min-width: 1440px) {
  footer {
    ...
    background-position: top 32.7rem left -20.5rem;
    display: grid;
