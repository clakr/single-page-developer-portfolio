...
@media screen and (min-width: 768px) {
  section {
    background-position: top 8.6rem left -26.5rem, top 47.1rem right -6.45rem;
  }
...
@media screen and (min-width: 1440px) {
  section {
    background-position: top 13.3rem left -10rem, top 52.1rem right 54.5rem;
  }
